//
//  TraditionCustomerTableViewCell.m
//  RYTableFormList
//
...
@implementation TraditionCustomerTableViewCell
...
+ (instancetype)initCellWithTableView:(UITableView*)tableView{
    ...
    TraditionCustomerTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:cellId];
    if (!cell) {
        cell = [[TraditionCustomerTableViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:cellId];
    }
